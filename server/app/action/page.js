...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3919)), "/Users/ajraou/keep-your-anger-low/kyadweb/app/action/page.js"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2756)), "/Users/ajraou/keep-your-anger-low/kyadweb/app/layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/ajraou/keep-your-anger-low/kyadweb/app/action/page.js"];
    ...
    const originalPathname = "/action/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5008))
...
/* harmony import */ var _page_module_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6864);
...
const RegisterForm = ()=>{
    ...
    const [level, setLevel] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [time, setTime] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    const [acts, setActs] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
    const [kid, setKid] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    ...
    const listActs = ()=>{
        ...
        (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
            ...
            }).then((response)=>response.json()).then((data)=>setActs(data)).catch((error)=>console.error("Error fetching kids:", error));
        }, []);
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().cardlist),
            children: acts.map((act)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().cardkid),
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        ...
        }).then((response)=>response.json()).then((data)=>setKid(data.name)).catch((error)=>console.error("Error fetching kids:", error));
    }, []);
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                    className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().paragraph),
                    children: [
                        "Are you grateful to ",
                        kid,
                        "? ",
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                ...
                className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().form),
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("label", {
                                htmlFor: "description",
                                className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().label),
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
                                ...
                                id: "description",
                                value: description,
                                className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().input),
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                        type: "submit",
                        className: (_page_module_css__WEBPACK_IMPORTED_MODULE_3___default().button),
                        children: "ADD"
                    })
                ]
            }),
...
// Exports
module.exports = {
	"main": "page_main__iY5BK",
	"paragraph": "page_paragraph__Bu3R9",
	"form": "page_form__QMnbx",
	"div": "page_div__TCLD9",
	"label": "page_label__xCNq5",
	"input": "page_input__voZx1",
	"button": "page_button__Bd8rT",
	"inputusername": "page_inputusername__t0J79",
	"inputpass": "page_inputpass__GTBkL",
	"description": "page_description___hOGE",
	"code": "page_code__xOGVw",
	"grid": "page_grid__epUxM",
	"card": "page_card__j45z0",
	"center": "page_center__CZmEF",
	"logo": "page_logo__8jRDO",
	"content": "page_content__222Lc",
	"vercelLogo": "page_vercelLogo__Gt_9y",
	"rotate": "page_rotate__Ur0vB"
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/ajraou/keep-your-anger-low/kyadweb/app/action/page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,405,652], () => (__webpack_exec__(4043)));
