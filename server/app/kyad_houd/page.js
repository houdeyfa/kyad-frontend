...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4218)), "/Users/ajraou/keep-your-anger-low/kyadweb/app/kyad_houd/page.js"],
    ...
    const pages = ["/Users/ajraou/keep-your-anger-low/kyadweb/app/kyad_houd/page.js"];
    ...
    const originalPathname = "/kyad_houd/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4869))
...
/* harmony import */ var _page_module_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7354);
...
const HomePage = ()=>{
    ...
    const [kids, setKids] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        fetch("https://keep-your-anger-down-production.up.railway.app/kids/", {
            headers: {
                Authorization: `Token ${token}`
            }
        }).then((response)=>response.json()).then((data)=>setKids(data["kids"])).catch((error)=>console.error("Error fetching kids:", error));
    }, []);
    function renderKids() {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            className: (_page_module_css__WEBPACK_IMPORTED_MODULE_4___default().cardlist),
            children: kids.map((kid)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: (_page_module_css__WEBPACK_IMPORTED_MODULE_4___default().cardkid),
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                            children: kid.name
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            className: (_page_module_css__WEBPACK_IMPORTED_MODULE_4___default().addbutton),
                            onClick: ()=>router.push(`/kyad_houd/action?kid=${kid.id}`),
                            children: "+"
                        })
                    ]
                }))
...
// Exports
module.exports = {
	"main": "page_main__WrjIc",
	"cardkid": "page_cardkid__VDktE",
	"cardlist": "page_cardlist__qj1f8",
	"addbutton": "page_addbutton__Gvl9Q",
	"paragraph": "page_paragraph__B7Nly",
	"description": "page_description__ydhmU",
	"code": "page_code__PYzPa",
	"grid": "page_grid__3w5Z8",
	"card": "page_card__eJ8YB",
	"center": "page_center__tWib4",
	"logo": "page_logo__H8bvz",
	"content": "page_content__vEBXS",
	"vercelLogo": "page_vercelLogo___t7jT",
	"rotate": "page_rotate__n_FJn"
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/ajraou/keep-your-anger-low/kyadweb/app/kyad_houd/page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,405,188,613,621,652,642], () => (__webpack_exec__(7611)));
